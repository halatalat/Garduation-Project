...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into servicelist(servname,detail,type,requirement,price) values('$servname','$detail','$type','$requirement','$price')");
                     ...
                     <form method="post" name="addition"  >
                            <div class="card-body">
                                <table class="table table-bordered " dir="rtl">
                                   ...
                                   <tr>
                                       <th>نوع الخدمة </th>
                                       <td><input class="form-control" id="type" name="type" type="text" value=""  required /></td>
                                   </tr>
                                   <tr>
                                       <th>سعر الخدمة </th>
                                   ...
                                   <tr>
                                       ...
                                       <td><input class="form-control" id="requirement" name="requirement" type="text" value=""  required /></td>
